...
\lower 1.8cm \hbox to \paperwidth{%
    \hss
    \includegraphics[width=\paperwidth,height=1.0\paperheight,keepaspectratio=false]{assets/imagenes/libro3portada2026.pdf}%
    \hss
}
...
\texttt{<cedcsh@correo.ler.uam.mx>}\\[0.8em]
